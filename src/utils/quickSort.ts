...
function doQuickSort(helperArray: any, startIdx: any, endIdx: any, animations: any) {
    let pivotIdx;
...
function partitionArray(helperArray: any, startIdx: any, endIdx: any, animations: any) {
...
function swapEleInArray(helperArray: any, firstIdx: any, secondIdx: any) {
